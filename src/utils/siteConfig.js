module.exports = {
    siteUrl: `https://naughty-euclid-aa5edb.netlify.com`, // Site domain. Do not include a trailing slash!
    ...
    shortTitle: `MTB Trailscast`, // Used for App manifest e.g. Mobile Home Screen
